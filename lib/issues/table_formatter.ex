defmodule Issues.TableFormatter do
  ...
  identified by eadh header. That is, each header identifies a column,
  and those columns are extracted and printed from the rows.

  We calculate the width of each column to fit th longest element in that column.
  """
  ...
  @doc """
  Given a list or rows, where each row contains a keyed list 
  ...
  and a format string, write the extracted data onder control of the format string
  """
